...
- Coordination: contract 1.2.0 mirrored and the loaders aligned (docs/adr/0010; backcross docs/adr/0014). Any further contract change starts in backcross and is mirrored here by copying `contract/`; `python scripts/check_contract.py ../backcross` proves the copy. Undecided in 1.1.0: half-missing pairs (`AN`, `A-`), read as missing. Contract 1.3.0 (after M3): named token profiles under `contract/profiles/` and a crop selector, designed in backcross PLAN.md and docs/adr/0014.
