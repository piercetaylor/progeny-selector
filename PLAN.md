...
- Coordination: contract 1.1.0 mirrored and the loaders aligned (docs/adr/0010; isoline-browser docs/adr/0014). Any further contract change starts in isoline-browser and is mirrored here by copying `contract/`; `python scripts/check_contract.py ../isoline-browser` proves the copy. Undecided in 1.1.0: half-missing pairs (`AN`, `A-`), read as missing. Contract 1.2.0 (after M3): named token profiles under `contract/profiles/` and a crop selector, designed in isoline-browser PLAN.md and docs/adr/0014.
