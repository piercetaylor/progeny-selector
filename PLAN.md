...
- Milestone / phase: M1 complete. Since M1: `rule: run` for region targets (5bbe265, docs/adr/0011), advisory QC flag `family_donor_outlier` (96bcde4, docs/adr/0012), ADR 0007 amended with `ranking.mode` (cfd0394), contract 1.2.1 mirrored after the sibling's rename to Backcross (49ecc42). Last commit 49ecc42 plus this handoff refresh; pushed yes; CI green; Pages public at https://piercetaylor.github.io/progeny-selector/ and stays public for now.
