...
Status: questions 1, 2, 5, 6, 7 and 9 were settled by the maintainer on 2026-09-12. Question 3 (where the display helpers live) is still open and must be answered before phase 2. Questions 4 and 8 are open and must be answered before phase 6.
