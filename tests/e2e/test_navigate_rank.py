...
def test_keyboard_navigation(page: Page, app: ShinyAppProc) -> None:
    ...
    expect(page.locator("#navigate-gen_0 input[value='all']")).to_be_focused()
    page.keyboard.press("ArrowDown")
    expect(page.locator("#navigate-gen_0 input[value='g:BC2F1']")).to_be_checked()
...
def test_crumb_links_step_back(page: Page, app: ShinyAppProc) -> None:
    ...
    generations.expect_selected("all")
...
def test_no_family_node(page: Page, app: ShinyAppProc, tmp_path) -> None:
    ...
    table = controller.OutputDataFrame(page, "rank-table")
    table.expect_nrow(1)
    expect(page.locator("#rank-caption")).to_contain_text("> (no family))")
